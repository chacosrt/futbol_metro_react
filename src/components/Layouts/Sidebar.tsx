                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'dashboard' ? 'active' : ''} nav-link group w-full`}>
                                    <div className="flex items-center">                                        
                                        <img src="/assets/images_metro/icons/jugadores.png" width={25} height={20} alt="Logo" className="navbar-logo" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark"><NavLink to="/jugadores">{t('Jugadores')}</NavLink></span>
                                    </div>                            
                                </button>                                   
                            </li> 
